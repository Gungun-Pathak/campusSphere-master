...
<div id="default-carousel" className="relative w-full" data-carousel="slide">
    ...
    <div className="relative h-56 overflow-hidden rounded-lg md:h-96">
        ...
        <div className="hidden duration-700 ease-in-out" data-carousel-item>
            <img src="https://media.discordapp.net/attachments/1164497786964803585/1164821262082768927/.png?ex=65449b56&is=65322656&hm=a988d1577ccc03281d66b012ab269865e12fef378c7f712b105f95efdacdc232&=&width=1125&height=589" className="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 object-contain overflow-hidden" alt="..."/>
        </div>
        ...
        <div className="hidden duration-700 ease-in-out" data-carousel-item>
            <img src="https://media.discordapp.net/attachments/1164497786964803585/1164821262082768927/Design_3_1.png?ex=65449b56&is=65322656&hm=a988d1577ccc03281d66b012ab269865e12fef378c7f712b105f95efdacdc232&=&width=1125&height=589" className="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="..."/>
        </div>
    </div>
